...
<template>
  <div class="demo-money">
    ...
    <le-money></le-money>
    <h3>Money设置大小和数值</h3>
    <le-money :number="number" :size="20" ></le-money>
    <h3>Money设置大小和数值，设置颜色</h3>
    <le-money :number="number" :size="20" :color="color"></le-money>
    ...
    <h3>Money 删除线</h3>
    <le-money :number="number" :size="26" :color="color" moneyIcon="$" delete></le-money>
  </div>
</template>
<script>
export default {
